...
app = FastAPI(docs_url='/api/community/docs', redoc_url='/api/community/redoc', openapi_url='/api/community/openapi.json')
...
@app.get("/api/community/article/{article_id}")
...
@app.put("/api/community/article/{article_id}")
...
@app.delete("/api/community/article/{article_id}")
...
@app.get("/api/community/article/user/{user_id}")
...
@app.get("/api/community/article/search/{keyword}")
...
@app.get("/api/community/article/{article_id}/comment")
...
@app.get("/api/community/article/{article_id}/comment/{comment_id}")
